<template>
  <div class="p-4 w-full h-screen bg-cyan-300">
    ...
    <div class="flex justify-center flex-wrap">
      <div class="m-8 w-80" v-for="(note, index) in notes" :key="note.symbol">
...
const notes = reactive<
  Array<{ value: string; readonly: boolean; symbol: symbol }>
>(preNotes !== null ? JSON.parse(preNotes) : []);

function addNote() {
  notes.push({ value: "", readonly: false, symbol: Symbol() });
}
